    ...
    <section className="relative min-h-screen overflow-hidden pt-20">
      ...
      <div className="container relative mx-auto flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        <motion.h1
          ...
          className="mb-6 max-w-4xl font-serif text-4xl md:text-6xl lg:text-7xl text-white leading-tight"
        >
          {t.hero.title1}
          <br />
        ...
        >
          ...
          >
            <a href="mailto:info@sonnmatt.ch" className="flex items-center justify-center gap-2">
